:root {
  ...
  --text-dark: #2c3e50;
  --text-light: #95a5a6;
  /* Kurumsal gri (ekrandaki renk kartından) */
  --corp-gray: #A3A8AC;
}
...
#login-screen {
  ...
  background:
    linear-gradient(rgba(14, 27, 66, 0.6), rgba(14, 27, 66, 0.6)),
    url("giris.png");
...
.login-btn:hover {
  background: #B50925;
  box-shadow:
    0 10px 26px rgba(207, 10, 44, 0.28),
...
.login-btn:focus-visible {
  outline: none;
  box-shadow:
    0 0 0 3px rgba(14, 27, 66, 0.55),
    0 0 0 6px rgba(207, 10, 44, 0.30),
    0 0 18px rgba(207, 10, 44, 0.35);
  /* glow */
}
...
.penalty-field {
  background: radial-gradient(circle at 50% 30%, #2e7d32 0%, #1b5e20 40%, #0a250a 100%);
  ...
  overflow: hidden;
  perspective: 1000px;
  box-shadow: 0 0 30px rgba(0, 242, 255, 0.4), inset 0 0 100px rgba(0, 0, 0, 0.9);
  display: flex;
  flex-direction: column;
  justify-content: flex-start;
}
...
.stadium-stands {
  ...
  width: 100%;
  height: 120px;
  background: radial-gradient(circle, rgba(0, 242, 255, 0.1) 1px, transparent 1px), linear-gradient(to bottom, #050a14 0%, #0e1b42 100%);
...
.gamer-modal {
  ...
  box-shadow: 0 0 30px rgba(0, 242, 255, 0.4), inset 0 0 15px rgba(0, 242, 255, 0.1) !important;
...
.grass-stripes {
  ...
  width: 100%;
  height: 100%;
  background: repeating-linear-gradient(180deg, rgba(255, 255, 255, 0.03) 0%, rgba(255, 255, 255, 0.03) 40px, transparent 40px, transparent 80px);
  z-index: 0;
...
.goal-net {
  ...
  width: 310px;
  height: 155px;
  background: repeating-linear-gradient(45deg, transparent, transparent 5px, rgba(255, 255, 255, 0.3) 5px, rgba(255, 255, 255, 0.3) 6px), repeating-linear-gradient(-45deg, transparent, transparent 5px, rgba(255, 255, 255, 0.3) 5px, rgba(255, 255, 255, 0.3) 6px);
...
.football {
  ...
  background-image: radial-gradient(circle at 50% 50%, rgba(0, 0, 0, 0.1) 40%, transparent 50%), conic-gradient(#fff 0deg, #fff 45deg, #222 45deg, #222 90deg, #fff 90deg, #fff 135deg, #222 135deg, #222 180deg, #fff 180deg, #fff 225deg, #222 225deg, #222 270deg, #fff 270deg, #fff 315deg, #222 315deg, #222 360deg);
  background-size: 200% 200%;
  box-shadow: inset -5px -5px 10px rgba(0, 0, 0, 0.4), 0 5px 10px rgba(0, 0, 0, 0.3);
  position: relative;
...
.torso {
  ...
  position: relative;
  z-index: 3;
  box-shadow: 0 3px 6px rgba(0, 0, 0, 0.4), inset 0 4px 6px rgba(255, 255, 255, 0.4);
  display: flex;
  align-items: center;
  justify-content: center;
  font-weight: bold;
...
.torso::before {
  ...
  right: 0;
  bottom: 0;
  background: linear-gradient(to right, rgba(0, 0, 0, 0.05), transparent 20%, transparent 80%, rgba(0, 0, 0, 0.05)), linear-gradient(to bottom, transparent 50%, rgba(0, 0, 0, 0.1));
  z-index: 1;
}
...
.shoe {
  ...
  box-shadow: 0 3px 6px rgba(0, 0, 0, 0.4), inset -3px -3px 4px rgba(0, 0, 0, 0.4);
...
.shooter-wrapper .torso {
  ...
  box-shadow: 0 3px 6px rgba(0, 0, 0, 0.3), inset 0 4px 6px rgba(255, 255, 255, 0.2);
}
...
.shooter-wrapper .torso::before {
  ...
  right: 0;
  bottom: 0;
  background: linear-gradient(to right, rgba(0, 0, 0, 0.1), transparent 20%, transparent 80%, rgba(0, 0, 0, 0.1)), linear-gradient(to bottom, transparent 50%, rgba(0, 0, 0, 0.2));
  z-index: 1;
}
...
.q-dash-agent-scores .das-name {
  font-weight: 700;
  /* Dashboard kartı açık zemin: isimler koyu olmalı */
...
/* Üst bardaki "X sonuç / Y" sayacı kaldır */
#searchResultCount {
  display: none !important;
}
...
.home-hero {
  ...
  justify-content: space-between;
  gap: 16px;
  background: linear-gradient(135deg, rgba(14, 27, 66, 0.92), rgba(14, 27, 66, 0.75));
...
.home-hero-title #home-welcome-user {
  color: var(--secondary);
  font-weight: 900;
}
...
/* Ana sayfa: Bugün Neler Var + Duyurular otomatik çekiliyor */
#home-edit-today,
#home-edit-ann {
  display: none !important;
}
...
.home-quote {
  ...
  box-shadow:
    0 4px 15px rgba(31, 38, 135, 0.05),
...
.home-quote::before {
  ...
  right: 0;
  bottom: 0;
  background: linear-gradient(120deg, rgba(237, 242, 247, 0.4) 0%, rgba(255, 255, 255, 0.1) 100%);
  z-index: -1;
}
