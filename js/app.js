...
function getCategorySelectHtml(currentCategory, id) {
    ...
    // Stil düzenlemesi: Kart içine tam oturması için
    return `<select id="${id}" class="swal2-input custom-swal-select" style="width:100%; margin:0; height:30px; font-size:0.8rem; padding:0 5px;">${options}</select>`;
}
...
// ==========================================================
// --- KART EKLEME VE DÜZENLEME (ÖNİZLEMELİ TASARIM) ---
// ==========================================================
